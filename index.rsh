...
export const main = Reach.App(() => {
    ...
    const state = parallelReduce({
        ...
        .api(
            ...
            // Assumes
            (() => {
                assume(wl.member(this), 'you must be a whitelist member to claim swap proceeds');
            ...
            // Consensus
            ((res) => {
                require(wl.member(this), 'you must be a whitelist member to claim swap proceeds');
